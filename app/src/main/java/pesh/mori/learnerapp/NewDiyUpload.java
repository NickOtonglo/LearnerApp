...
public class NewDiyUpload extends AppCompatActivity {
    ...
    private RadioButton radioAudio,radioVideo,radioYes,radioNo,radioDoc;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_new_diy_upload);
        ...
        spinnerTag = findViewById(R.id.spinner_diy_tag);

        videoPlayerLayout = findViewById(R.id.layout_upload_diy_video_player);
        layoutPrice = findViewById(R.id.layout_diy_price);
        imageLayout = (LinearLayout) findViewById(R.id.diy_layout_2);
        audioLayout = (LinearLayout) findViewById(R.id.diy_layout_3);
        videoLayout = (LinearLayout) findViewById(R.id.diy_layout_4);
        docLayout = (LinearLayout)findViewById(R.id.diy_layout_7);
        layoutEditTexts = (LinearLayout) findViewById(R.id.diy_layout_5);
        filePrice = findViewById(R.id.txt_file_price_diy);
        progressBuffer = findViewById(R.id.buffer_progress_upload_diy);

        //radioImage = (RadioButton) findViewById(R.id.radio_diy_image);
        radioAudio = (RadioButton) findViewById(R.id.radio_diy_audio);
        radioVideo = (RadioButton) findViewById(R.id.radio_diy_video);
        radioDoc = (RadioButton)findViewById(R.id.radio_diy_doc);
        radioYes = findViewById(R.id.radio_diy_bid_yes);
        radioNo = findViewById(R.id.radio_diy_bid_no);
        radioYes.setChecked(true);

        fileTitle = (EditText) findViewById(R.id.txt_diy_file_title);
        fileDescription = (EditText) findViewById(R.id.txt_diy_file_description);

        btnAudio = (Button) findViewById(R.id.btn_select_audio_diy);
        btnImage = (Button) findViewById(R.id.btn_select_image_diy);
        btnVideo = (Button) findViewById(R.id.btn_select_video_diy);
        btnDoc = (Button)findViewById(R.id.btn_select_doc_diy);
        btnUpload = (Button) findViewById(R.id.btn_upload_diy_file);

        imageImage = (ImageView)findViewById(R.id.btn_diy_select_image);
        playAudio = (ImageButton)findViewById(R.id.btn_play_audio_diy);
        videoImage = (ImageView)findViewById(R.id.btn_diy_select_video);
        docTextView = (TextView)findViewById(R.id.txt_diy_select_doc);
        videoView = findViewById(R.id.img_upload_diy_play_video);
        ...
        mAllPostsSplit = FirebaseDatabase.getInstance().getReference().child("AllPostsSplit").child("DIY");
    ...
    private void loadSpinners(){
        ...
        mLists.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                ...
                ArrayAdapter<String> tagsAdapter = new ArrayAdapter<String>(NewDiyUpload.this,android.R.layout.simple_spinner_item,getTags);
...
//            }
    ...
    private void startPosting() {
        ...
        final StorageMetadata metadata = new StorageMetadata.Builder()
                .setCustomMetadata("diy",getFileName(mFileUri).replace(" ","_"))
                .build();
...
//                            mPostNode.child("Category").setValue("DIY");
...
//                            mPublishedItems.child(keyRef).child("Category").setValue("DIY");
...
//                            mAllPostsSplit.child(keyRef).child("Category").setValue("DIY");
...
//                            mAllPostsSplit.child(keyRef).child("Tag").setValue(spinnerTag.getSelectedItem().toString());
//
...
//                            mUpload.child("tag").setValue(spinnerTag.getSelectedItem().toString());
...
//                            }
//                            mProgress.dismiss();
//                            Toast.makeText(NewDiyUpload.this, "DIY uploaded", Toast.LENGTH_LONG).show();
//                            finish();
//                        }
//
//                        @Override
//                        public void onCancelled(DatabaseError databaseError) {
//                            Toast.makeText(NewDiyUpload.this, databaseError.getMessage(), Toast.LENGTH_LONG).show();
//                        }
//                    });
//                }
//            });
...
//                            mAllPostsSplit.child(keyRef).child("Tag").setValue(spinnerTag.getSelectedItem().toString());
                                    ...
                                    mProgress.dismiss();
                                    Toast.makeText(NewDiyUpload.this, R.string.info_post_created, Toast.LENGTH_LONG).show();
...
//                            mAllPostsSplit.child(keyRef).child("Tag").setValue(spinnerTag.getSelectedItem().toString());
    ...
    public void checkAudioState(){
        ...
        if (mFileUri==null){
            Toast.makeText(NewDiyUpload.this, "No audio file selected", Toast.LENGTH_SHORT).show();
        } else {
            if (mediaPlayer.isPlaying()){
                playAudio.setImageResource(R.mipmap.baseline_play_circle_outline_white_18dp);
                mediaPlayer.stop();
                ...
                try {
                    ...
                    mediaPlayer.setDataSource(NewDiyUpload.this,mFileUri);
                } catch (IOException e) {
                    e.printStackTrace();
...
//                        .setAspectRatio(4,3)
        ...
        if (requestCode==VIDEO_REQUEST){
            try {
                ...
                Picasso.with(NewDiyUpload.this).load(uri).into(videoImage);
