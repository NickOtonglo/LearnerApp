...
//
//        fabNew = mynotes.findViewById(R.id.fab_new_note);
...
//                            Toast.makeText(getContext(), "No results", Toast.LENGTH_SHORT).show();
                            ...
                            resultsActivity.putExtra("outgoing_intent","mynotes");
    ...
    public static class NotesViewHolder extends RecyclerView.ViewHolder{
        ...
        public void setNull(){
            ...
            txtEmpty.setText("No Notes to Display");
        }
    }
