...
public class mydownloads extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        View mydownloads = inflater.inflate( R.layout.fragment_mydownloads, container, false );
//        Toast.makeText(getActivity(), "INFO | Under Development",  Toast.LENGTH_SHORT).show();
        ...
        mFilesItems = FirebaseDatabase.getInstance().getReference().child("OwnedItems").child(mAuth.getCurrentUser().getUid());
        ...
        txtEmpty = mydownloads.findViewById(R.id.txt_download_empty);
        ...
        //radioImage = mydownloads.findViewById(R.id.radio_image_download);
        radioAudio = mydownloads.findViewById(R.id.radio_audio_download);
        radioVideo = mydownloads.findViewById(R.id.radio_video_download);
        radioDoc = mydownloads.findViewById(R.id.radio_document_download);
...
//        });
        ...
        mRecycler = (RecyclerView)mydownloads.findViewById(R.id.layout_recycler_mydownloads);
...
//        }
        ...
        FirebaseRecyclerAdapter<File,PostsViewHolder_BigCard> firebaseRecyclerAdapter = new FirebaseRecyclerAdapter<File, PostsViewHolder_BigCard>(
                ...
                R.layout.card_big,
                PostsViewHolder_BigCard.class,
                mFilesItems.orderByChild("FileType").equalTo(fileType)
        ) {
            @Override
            protected void populateViewHolder(final PostsViewHolder_BigCard viewHolder, final File model, int position) {
                final String fileKey = getRef(position).getKey();
    ...
    public String getAuthorDetails(final String key){
        FirebaseDatabase.getInstance().getReference().child("Files").addValueEventListener(new ValueEventListener() {
            @Override
            public void onDataChange(DataSnapshot dataSnapshot) {
    ...
    public void makeTransaction(){
        TransactionsActivity transactions = new TransactionsActivity();
    ...
    public void onCreateOptionsMenu(Menu menu, MenuInflater inflater) {
        ...
        SearchView.OnQueryTextListener queryTextListener = new SearchView.OnQueryTextListener() {
            ...
            public boolean onQueryTextSubmit(String s) {
                performSearch(s,"OwnedItems","mydownloads");
