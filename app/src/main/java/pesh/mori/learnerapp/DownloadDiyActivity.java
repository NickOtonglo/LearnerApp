...
public class DownloadDiyActivity extends AppCompatActivity {

    private final AppCompatActivity activity = DownloadDiyActivity.this;
    ...
    private RecyclerView recyclerDiy;
    ...
    private RadioButton radioAudio,radioVideo,radioDoc,radioImage;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        diyCategory = getIntent().getExtras().getString("category");
        getSupportActionBar().setDisplayHomeAsUpEnabled( true );
        getSupportActionBar().setSubtitle(diyCategory);

        Snackbar snackbar = Snackbar.make(findViewById(android.R.id.content), diyCategory, Snackbar.LENGTH_LONG);
        snackbar.show();
        ...
        mFilesItems = FirebaseDatabase.getInstance().getReference().child("AllPostsSplit").child("DIY");
        mFilesItems.keepSynced(true);
        mFiles = FirebaseDatabase.getInstance().getReference().child("DIY");
        mFiles.keepSynced(true);
        mStorage = FirebaseStorage.getInstance().getReference().child("DIY");
...
//        radioAudio = findViewById(R.id.radio_audio_act_diy);
//        radioVideo = findViewById(R.id.radio_video_act_diy);
//        radioDoc = findViewById(R.id.radio_document_act_diy);
//        //radioImage = findViewById(R.id.radio_image_act_diy);
...
//        });
        ...
        mRecycler = (RecyclerView)findViewById(R.id.layout_recycler_act_diy);
        ...
        loadList(mFilesItems.orderByChild("Tag").equalTo(diyCategory));
    }
    ...
    public void setNull(){
        ...
        recyclerDiy.setVisibility(View.GONE);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == R.id.upload){
            ...
            startActivity(new Intent(DownloadDiyActivity.this,NewDiyUpload.class));
    ...
    public void checkOwnershipStatus(final String key){
        FirebaseDatabase.getInstance().getReference().child("DIY").child(key).addListenerForSingleValueEvent(new ValueEventListener() {
            @Override
            public void onDataChange(DataSnapshot dataSnapshot) {
