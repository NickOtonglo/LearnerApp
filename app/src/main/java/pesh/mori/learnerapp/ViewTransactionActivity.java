        ...
        if (incomingIntent.equals("TransactionHistoryActivity_TokensFragment")){
            FirebaseDatabase.getInstance().getReference().child("TokenPurchase").child(mAuth.getCurrentUser().getUid()).child(postKey).addListenerForSingleValueEvent(new ValueEventListener() {
                ...
                public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                    ...
                    txtItem.setText(R.string.title_mpesa_token_topup);
                ...
                public void onDataChange(@NonNull final DataSnapshot dataSnapshot) {
                    ...
                    if (dataSnapshot.child("ItemType").getValue().equals("Token")){
                        if (incomingIntent.equals("TransactionHistoryActivity_PurchaseFragment")){
                            txtItem.setText(R.string.title_tokens_sent);
                        }else if (incomingIntent.equals("TransactionHistoryActivity_SalesFragment")) {
                            txtItem.setText(R.string.title_tokens_received);
                        }
                    } else if (dataSnapshot.child("ItemType").getValue().equals(getString(R.string.firebase_ref_posts_type_1))){
                        FirebaseDatabase.getInstance().getReference().child(getString(R.string.firebase_ref_posts_all)).child(String.valueOf(dataSnapshot.child("Item").getValue())).addListenerForSingleValueEvent(new ValueEventListener() {
                            @Override
                            public void onDataChange(@NonNull final DataSnapshot dataSnapshot) {
                                txtItemLabel.setText(R.string.hint_item_tap_to_open);
                    ...
                    } else if (dataSnapshot.child("ItemType").getValue().equals(getString(R.string.firebase_ref_posts_type_2))){
                        FirebaseDatabase.getInstance().getReference().child(getString(R.string.firebase_ref_posts_all)).child(String.valueOf(dataSnapshot.child("Item").getValue())).addListenerForSingleValueEvent(new ValueEventListener() {
                            @Override
                            public void onDataChange(@NonNull final DataSnapshot dataSnapshot) {
                                txtItemLabel.setText(R.string.hint_item_tap_to_open);
